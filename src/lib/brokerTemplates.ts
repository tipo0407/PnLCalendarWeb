...
export const BROKER_TEMPLATES: BrokerTemplate[] = [
  ...
  },
  {
    id: 'tradestation',
    name: 'TradeStation',
    hint: 'Trades / Account history CSV',
    signatures: ['Net Profit/Loss', 'Entry DateTime', 'Exit DateTime', 'L/S'],
    columns: {
      date: ['Entry DateTime', 'Entry Date', 'Date'],
      symbol: ['Symbol'],
      direction: ['L/S', 'Long/Short', 'Side'],
      size: ['Qty', 'Shares', 'Contracts'],
      entryPrice: ['Entry Price', 'Avg Entry Price'],
      exitPrice: ['Exit Price', 'Avg Exit Price'],
      entryTime: ['Entry DateTime', 'Entry Time'],
      exitTime: ['Exit DateTime', 'Exit Time'],
      profitLoss: ['Net Profit/Loss', 'Profit/Loss', 'P/L'],
    },
  },
  {
    id: 'metatrader',
    name: 'MetaTrader 4 / 5',
    hint: 'History / Deals report',
    signatures: ['Ticket', 'Profit', 'Volume', 'S / L'],
    columns: {
      date: ['Open Time', 'Time', 'Date'],
      symbol: ['Symbol', 'Item'],
      direction: ['Type', 'S / L'],
      size: ['Volume', 'Lots', 'Size'],
      entryPrice: ['Open Price', 'Price'],
      exitPrice: ['Close Price'],
      profitLoss: ['Profit', 'P/L'],
      tradeNumber: ['Ticket', 'Order', 'Deal'],
    },
  },
  {
    id: 'robinhood',
    name: 'Robinhood',
    hint: 'Account / orders CSV',
    signatures: ['Instrument', 'Side', 'Average Price', 'State'],
    columns: {
      date: ['Created At', 'Filled At', 'Date'],
      symbol: ['Instrument', 'Symbol'],
      direction: ['Side'],
      size: ['Quantity', 'Shares'],
      entryPrice: ['Average Price', 'Price'],
      profitLoss: ['Total Return', 'Realized P/L', 'Amount'],
    },
  },
  {
    id: 'binance',
    name: 'Binance (Spot/Futures)',
    hint: 'Trade history CSV',
    signatures: ['Realized Profit', 'Quantity', 'Price', 'Fee Coin'],
    columns: {
      date: ['Date(UTC)', 'Time', 'Date'],
      symbol: ['Pair', 'Symbol', 'Market'],
      direction: ['Side', 'Type'],
      size: ['Quantity', 'Amount', 'Executed'],
      entryPrice: ['Price', 'Avg Price'],
      profitLoss: ['Realized Profit', 'Realized PNL', 'PnL'],
    },
  },
];
