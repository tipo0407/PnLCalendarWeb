...
const EN: Record<string, string> = {
  ...
  'tab.review': 'Review',
  'review.reportTitle': 'Weekly Review Report',
  'review.reportTitleM': 'Monthly Review Report',
  'review.reportTitleY': 'Annual Review Report',
  'review.eyebrow': 'WEEKLY REVIEW',
  'review.eyebrowM': 'MONTHLY REVIEW',
  'review.eyebrowY': 'ANNUAL REVIEW',
  'review.week': 'Week',
  'review.month': 'Month',
  'review.year': 'Year',
  'review.topLeaksM': 'Top leaks this month',
  'review.topLeaksY': 'Top leaks this year',
  'review.generated': 'Generated',
  'review.topLeaks': 'Top leaks this week',
  'review.disclaimer': 'This is a trading journal and self-review tool, not investment advice. Past performance does not guarantee future results.',
...
const ZH: Record<string, string> = {
  ...
  'tab.atlas': '交易分析',
  'tab.review': '复盘',
  'review.reportTitle': '每周复盘报告',
  'review.reportTitleM': '每月复盘报告',
  'review.reportTitleY': '年度复盘报告',
  'review.eyebrow': '每周复盘',
  'review.eyebrowM': '每月复盘',
  'review.eyebrowY': '年度复盘',
  'review.week': '周',
  'review.month': '月',
  'review.year': '年',
  'review.topLeaksM': '本月主要漏损',
  'review.topLeaksY': '本年主要漏损',
  'review.generated': '生成于',
  'review.topLeaks': '本周主要漏损',
  'review.disclaimer': '本工具为交易日志与自我复盘工具，不构成投资建议。过往表现不代表未来收益。',
  'brand.sub': '交易表现日志',
  'action.settings': '设置',
  'action.plans': '套餐与价格',
  'settings.title': '设置',
